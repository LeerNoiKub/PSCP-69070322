...
```text
รับค่า สองตัว วิธีการProcess คือให้เช็คเงื่อนไข ว่าตรงรึป่าว เเละถ้าตรงก็ตรงไปเช็คเงื่อนไขอีกทีนึง
```
...
```text
อธิบายว่าลูป ในลูปคืออะไร เเละใช้ยังไง
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนทุกอย่างด้วยตัวเองครับ
```

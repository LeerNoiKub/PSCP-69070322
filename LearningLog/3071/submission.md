...
```text
หาเศษของจำนวนที่อยู่ระหว่างค่า
```
...
```text
หาเคษก็ใช้เปอเซ็น เเละ loop ครับ
```
...
```text
ช่วยอธิบายโจทครับ ผมอ่านโจทไม่เข้า เเละ งงว่าทำไมถึงได้4 ใน testcase ตัวเเรก
```

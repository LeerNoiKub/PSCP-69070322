...
```text
รับ input str 2 ตัว ให้มันเช็กว่า เข้าเงื่อนไขไหนบ้าง เเละให้ปริ้นออกมา
```
...
```text
เขียน เงื่อนไขออกมาให้ใส่อินพุต เเล้วออกมาให้ตรง
ให้มันตรวจอินพุต ทั้งสองค่าที่ใส่ไป ใช้ if elif else
```
...
```text
เหมือนกับเเผนเเรกครับ เเต่ เปลี่ยนโค้ดอันที่มันต้องเช็คว่า input 1 and input 2 มันเหมือนกัน เพราะทดสอบเเล้วมันออกมาไม่ตรง
```
...
ตรง
    ...
    print(color1)
ตอนเเรกไม่รู้จริงๆครับ  ตอนเเรกเขียน
    ...
    print("Red")
มันจะไปซ้ำกับตัวเเรก ทำให้อินพุต มันออกมาเป็น
orange
เพื่อนมาบอกว่าลองให้ตัวนึงเก็บหลายตัวไว้เเละให้มันเช็ค เลยออกมาเป็นเเบบนั้นเเละถูกครับ
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนทุกอย่าง ด้วยตัวเอง ครับ ยกเว้น คำสั้ง  in  มีเพื่อนใบ้มาครับครับ
```

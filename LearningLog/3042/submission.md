...
```text
ใช้ for loop ให้มันเเสดงค่าเรื่อยๆ
```
...
```text
ตรง in range เพื่อนบอกให้เติม+1 ไปด้วย เพราะ มันจะไม่เเสดงตัวสุดท้ายออกมา
เเล้วก็ * เพื่อเอาวงเล็บออก
```

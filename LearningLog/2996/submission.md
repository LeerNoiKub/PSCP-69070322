...
Output:
ตัวอักษรกลับด้าน เเละตัวเล็ก

Constraints:
ใช้คำสั้ง .lower กับ ::-1
```
...
```text
ผมจำคำสั่งให้มันกลับด้านไม่ได้
```

คุณยังทำอะไรด้วยตนเอง

```text
ใส่อินพุต ทำให้มันตัวเล็ก ที่เหลือทุกอย่างยกเว้นทำให้มันกลับด้าน
```

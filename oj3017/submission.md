...
```text
input 
มี 1 ตัว จำนวนเงินรวมได้สั่งอาหารไป
output
จำนวนเงินทั้งหมด เเละจุดทศนิยมไม่เกิน2จุด
constraints
โจทนี้มี ทริค คือ ต้องคำนวนภาษี 7% เเละ ค่าบริการ อีก 10% เเละค่าบริการมีขั้นต่ำ 50 เเละ ไม่เกิน 1000
เราต้องหาค่าบริการก่อน เเละเอาไปบวกจำนวนราคาอาหารเเละเครื่องดื่ม จากนั้นต้องเอาที่เราเพิ่งรวมไป หาภาษี7% เเละเอา จำนวนค่าอาหาร ที่บวกค่าบริการเเล้ว มาบวก กับ ภาษีที่เพิ่งหามา เเละเราจะได้คำตอบครับ
```
...
1 ใส่อินพุต
2 เช็คค่าบริการ 
 2.1ถ้าต่ำกว่า 50 ก็เเปลงให้เป็น 50
 2.2ถ้ามากกว่า 1000 ก็เเปลงเป็น 1000
3 หาภาษี
4 ปริ้น ออกมาโดยทศนิยมต้อง2ตัว
```
...
```text
ใช้0 ดูก่อนครับ ว่ามีเออเร่อรึป่าว
```

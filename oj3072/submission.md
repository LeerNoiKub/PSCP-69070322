...
```text
ตอนเเรกว่าจะใช้list เเละให้ เช็คว่าinput ตรงกับในlist กี่ตัว
```
...
```text
ผมไม่รู้ว่าจะ print ออกมายังไง เพื่อนบอกให้ใช้ f string เลยเข้าใจครับ
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนด้วยตัวเองหมดครับ
```
